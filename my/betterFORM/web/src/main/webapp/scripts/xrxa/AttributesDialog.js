...
define([
    ...
    "dijit/Dialog",
    "xrxa/Attribute",
    "xrxa/InsertAttributeButton"
    ], 
    function(declare, xhr, on, domConstruct, domClass, query, Button, Dialog, Attribute, InsertAttributeButton){	
    		  ...
    		  getAttributeOptions : function(){ 
    			  ...
    			  xhr.post({
    			      ...
    			      load: function(result){ 
    			    	  ...
    			    	  var attributeInfo = result.documentElement;    			    	  	
