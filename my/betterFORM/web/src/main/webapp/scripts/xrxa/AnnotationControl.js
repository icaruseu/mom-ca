...
define([
    ...
    "xrxa/Selection",
    "xrxa/Header"
], function(declare, event, sniff, xhr, domConstruct, domClass, domAttr, has, _WidgetBase, parser, PasteDialog, Content, Selection, Header){
