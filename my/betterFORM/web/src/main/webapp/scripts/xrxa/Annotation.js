...
define([
    ...
    "xrxa/StartTag",
    "xrxa/EndTag",   
    "xrxa/AttributesDialog"
    ], 
    function(declare, xhr, win, domConstruct, domClass, domStyle, _WidgetBase, StartTag, EndTag, AttributesDialog){
	    return declare(_WidgetBase, 
	    	{
	    	  ...
	    	  createContent: function (){
	    		  ...
	    		  var annotation = this;
	    		  require(["xrxa/Content"], function(Content){
	    	  ...
	    	  annotationInfo : function(){	  
	    		  ...
	    		  xhr.post({
	    		      ...
	    		      load: function(result){ 	        	
	    		    	  	var annotationInfo = result.documentElement;	    		    	    	
